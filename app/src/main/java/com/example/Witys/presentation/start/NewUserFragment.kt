...
class NewUserFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        var view = inflater.inflate(R.layout.fragment_new_user, container, false)
        mBtnReg = view.findViewById(R.id.regist_new_user)
        mBtnReg.setOnClickListener{
            var intent = Intent(context, ProfilActivity::class.java)
