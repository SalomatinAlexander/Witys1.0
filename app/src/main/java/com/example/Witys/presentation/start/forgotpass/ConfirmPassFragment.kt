...
class ConfirmPassFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        var view = inflater.inflate(R.layout.fragment_confirm_pass,
            container, false)
        var btn = view.findViewById<Button>(R.id.confirm_btn)
        btn.setOnClickListener {
            requireActivity().supportFragmentManager
                .beginTransaction()
                .replace(R.id.container_layout, NewPassFragment())
